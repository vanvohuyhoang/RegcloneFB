...
def process_device(data_run):
    ...
    def clear_data_lite():
        ...
        time.sleep(1)
        click('syssetting.png', 3, 'Nhấn Vào Cài Đặt Hệ Thống')
        click('settingapp.png', 3, 'Nhấn Vào Cài Đặt App')
        click('caidatvpn.png', 3, 'Nhấn Vào Cài Đặt VPN')
        click('appstop.png', 3, 'Nhấn Buộc Dừng VPN')
        click('ok12.png', 3, 'Xác Nhận Buộc Dừng VPN')
        click('bonho.png', 3, 'nhan bo nho')
        click('cache.png', 3, 'nhan bo nho')
        click('data.png', 3, 'nhan bo nho')
        click('ok12.png', 3, 'nhan bo nho')
        system_cmd('KEYCODE_HOME')
        time.sleep(1)       
        click('syssetting.png', 3, 'Nhấn Vào Cài Đặt Hệ Thống')
        click('settingapp.png', 3, 'Nhấn Vào Cài Đặt App')
        click('litesetting.png', 3, 'Nhấn Vào Cài Đặt Lite')
        click('appstop.png', 3, 'Nhấn Buộc Dừng Lite')
        click('ok12.png', 3, 'Xác Nhận Buộc Dừng Lite')
        click('bonho.png', 3, 'nhan bo nho')
        click('cache.png', 3, 'nhan bo nho')
        click('data.png', 3, 'nhan bo nho')
        click('taikhoanvacaidat.png', 3, 'nhan bo nho')
        click('ok12.png', 1, 'nhan bo nho')
