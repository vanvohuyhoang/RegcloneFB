...
import threading, random, subprocess, time, random, os, unidecode, requests, sys, cv2, numpy as np, requests, re
os.system('cls')
...
def process_device(data_run):
    ...
    def clear_data_lite():
        ...
        time.sleep(1)
        subprocess.run(f'adb -s {devices} shell pm clear com.facebook.lite', shell=True)
        subprocess.run(f'adb -s {devices} shell pm clear com.jrzheng.supervpnfree', shell=True)
        system_cmd('KEYCODE_HOME')
        time.sleep(5)
        creat_acc()
    ...
    def creat_acc():
        ...
        system_cmd('KEYCODE_HOME')
        time.sleep(1)
        click('spvpn.png', 3, 'Đang mở app VPN')
        click('cancel.png', 3, 'từ chối')
        click('nothank.png', 5, 'KHÔNG CẢM ƠN')
        click('chonvpn.png', 5, 'chọn vpn') 
        list_vpn = ['vpn.png', 'vpn1.png', 'vpn2.png', 'vpn3.png', 'vpn4.png', 'vpn5.png']
        random_vpn = random.choice(list_vpn)
        click(random_vpn, 5, 'Click chọn vpn')      
        click('xacnhanvpn.png', 8, 'Đang mở app facebook lite')
        system_cmd('KEYCODE_HOME')
        time.sleep(1)       
...
data_runs = [
      ...
      {'id_divice': 'emulator-5564', 'part_png': 'D:/RegCloneFbDl/DataReg/screen6/screenshot.png', 'part_obj': 'D:/RegCloneFbDl/DataReg/screen6/', 'key_mail': 'lg7fn52dojkecvibc5focg7lju'},
      {'id_divice': 'emulator-5566', 'part_png': 'D:/RegCloneFbDl/DataReg/screen7/screenshot.png', 'part_obj': 'D:/RegCloneFbDl/DataReg/screen7/', 'key_mail': 'lg7fn57dojkecvibc5focg7lju'},
      {'id_divice': 'emulator-5568', 'part_png': 'D:/RegCloneFbDl/DataReg/screen8/screenshot.png', 'part_obj': 'D:/RegCloneFbDl/DataReg/screen8/', 'key_mail': 'lg7fn67dojkecvibc5focg7lju'},
      {'id_divice': 'emulator-5570', 'part_png': 'D:/RegCloneFbDl/DataReg/screen9/screenshot.png', 'part_obj': 'D:/RegCloneFbDl/DataReg/screen9/', 'key_mail': 'lg7fn69dojkecvibc5focg7lju'},
      {'id_divice': 'emulator-5570', 'part_png': 'D:/RegCloneFbDl/DataReg/screen10/screenshot.png', 'part_obj': 'D:/RegCloneFbDl/DataReg/screen10/', 'key_mail': 'lg7fn74dojkecvibc5focg7lju'},
 #     {'id_divice': 'emulator-5572', 'part_png': 'D:/RegCloneFbDl/DataReg/screen11/screenshot.png', 'part_obj': 'D:/RegCloneFbDl/DataReg/screen11/', 'key_mail': 'lg7fn52dojkecvibc5focg7lju'},
 #     {'id_divice': 'emulator-5574', 'part_png': 'D:/RegCloneFbDl/DataReg/screen12/screenshot.png', 'part_obj': 'D:/RegCloneFbDl/DataReg/screen12/', 'key_mail': 'lg7fn57dojkecvibc5focg7lju'}
]
